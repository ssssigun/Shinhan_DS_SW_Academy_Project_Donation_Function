  ...
  return (
    <>
      ...
      <div className="OrderFreeTakeOutWrapper">
        ...
        <AllAgreeCheckBox
          checked={(allAgreed, selectedOptions.option4)}
        ...
        <CheckBox
          ...
          // defaultChecked
          checked={(agreements.termsAgreed, selectedOptions.option1)}
        ...
        <CheckBox
          ...
          // labelStyle={{ fontSize: '16px' }}
          // defaultChecked
          checked={(agreements.provisonAgreed, selectedOptions.option2)}
        ...
        <CheckBox
          ...
          checked={(agreements.personalInfoAgreed, selectedOptions.option3)}
